...
Enable **Translucent windows** in Appearance settings to see behind Freemind. The window opacity slider adjusts the entire window from 65% to 100%, including native editors and terminals, and updates existing windows immediately. The option is off by default and respects macOS **Reduce Transparency**.

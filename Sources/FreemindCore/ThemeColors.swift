...
/// Shared palette resolution for native frontends.
public struct ThemeColors: Equatable, Sendable {
    public var style: AppColorTheme
    public var isDark: Bool
    public var custom: CustomTheme?
    public init(style: AppColorTheme = .forest, isDark: Bool = false, custom: CustomTheme? = nil) {
        self.style = style; self.isDark = isDark; self.custom = custom
    }

    public func hex(for role: ThemeColorRole) -> UInt32 {
    ...
    public func customCopy(name: String) -> CustomTheme {
